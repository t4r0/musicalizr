...
export class SpotifyLoginButton {
  ...
  login() : void {
    var params = 'client_id=0751903c1b62406880128de801b635f9&response_type=token&redirect_uri=http://localhost:4200/callback&scope=playlist-read-private playlist-read-collaborative streaming user-library-read';
